...
/// </summary>
public class deleteDQAInstanceAudit : AuditInstanceBase
{
    // Properties specific to DQAAudit

    public deleteDQAInstanceAudit() : base("DQAAudit") { }

    public deleteDQAInstanceAudit(DateTime updateDateTime, string dqaUID, string dqaDescription, string ErrMessage = null)
        : base(dqaUID, dqaDescription)
    {
